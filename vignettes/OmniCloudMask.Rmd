...
Next, let's download all of the rasters locally by warping the collection to 
a common projection, extent and resolution, using lazy=FALSE to write files to
disk. The returned object in this case is a warped `vrt_collection`.
