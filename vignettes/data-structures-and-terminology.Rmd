...
<div class="figure" style="text-align: center">
  <img src="figure/data-concepts.png" alt="Figure 1: Core data structures in vrtility: vrt_block, vrt_collection, and vrt_stack. Red, green, and blue lines represent raster bands; black boxes represent VRT files; t* labels indicate discrete epochs (time steps)." style="width: 100%;" />
  <p class="caption">Figure 1: Core data structures in vrtility: <code>vrt_block</code>, <code>vrt_collection</code>, and <code>vrt_stack</code>. Red, green, and blue lines represent raster bands; black boxes represent VRT files; t* labels indicate discrete epochs (time steps).</p>
</div>
