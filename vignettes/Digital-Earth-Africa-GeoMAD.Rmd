...
So let's get into it. First load vrtility, set the number of mirai daemons
you want to use (R processes that will download the data in parallel) and set 
some important environment variables that will allow you to access the
Digital Earth Africa data from the S3 bucket. Whilst, we can provide these 
config options in various `vrt_x` commands, setting them here means you don't 
...
<img src="figure/dea-geomad-plot-1.png" width="50%" /><img src="figure/dea-geomad-plot-2.png" width="50%" />
