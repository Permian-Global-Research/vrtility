...
across bands. note that where some bands dont exist, the median is used in 
place of the geometric median.


``` r
hls_composite <- multiband_reduce(hls_warp, reduce_fun = geomedian())
```
