...
available in four functions at present: `vrt_collect`, `vrt_set_maskfun`,
`vrt_compute` and `multiband_reduce`. In order to use asynchronous processing, 
in the `vrt_compute` function, we need to set `engine = "gdalraster"`. 
