...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Permian-Global-Research/vrtility", fork = TRUE)`.
...
Please note that the vrtility project is released with a [Contributor
Code of
Conduct](https://permian-global-research.github.io/vrtility/CODE_OF_CONDUCT.md).
